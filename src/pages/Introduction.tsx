export default function Introduction() {
  return (
    <div className="flex flex-col justify-center items-start gap-6 h-screen max-h-200 mt-30 sm:mt-0">
      ...
      <div className="text-gray-600 text-md md:text-md sm:w-3/4 md:w-1/2">
